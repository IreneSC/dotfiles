...
# TODO: Get the button map of the touchpad, extract the id, and use that instead.
xinput set-button-map 12 1 1 3 4 5 6 7 2> /dev/null
...
cd ~/workspace/crt-system/catkin_ws/src/crt_system/src/
source config.sh
cd - > /dev/null

export ROS_MASTER_URI_CRT=http://10.0.0.2:11311
export ROS_MASTER_URI=http://localhost:11311
source ~/workspace/crt-system/catkin_ws/devel/setup.bash
export GUROBI_HOME="/opt/gurobi811/linux64"
export PATH="${PATH}:${GUROBI_HOME}/bin"
export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:${GUROBI_HOME}/lib"

# if [ -z "$ENABLED_CAMERA_MEMORY" ]; then
#     sudo sh -c 'echo 1000 > /sys/module/usbcore/parameters/usbfs_memory_mb'
#     export ENABLED_CAMERA_MEMORY=1
# fi
